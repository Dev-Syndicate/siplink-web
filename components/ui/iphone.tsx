...
export interface IphoneProps extends HTMLAttributes<HTMLDivElement> {
  ...
  videoSrc?: string
  /**
   * Live interface to show on the screen, instead of an image or a video.
   * Rendered into the same punched-out screen window `src`/`videoSrc` use, so
   * the frame's rounded corners clip it.
   */
  children?: ReactNode
}
    ...
    >
      ...
      >
        ...
        <path
          ...
          className="fill-foreground stroke-foreground stroke-[0.5]"
